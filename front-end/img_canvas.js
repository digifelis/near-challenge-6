 ...
 */
 async function imgToCanvas(url) {
  ...
  function addWatermark(canvas, text) {
    ...
    ctx.textSize = 52;
    ctx.fillText(text, 200, 290);
    ctx.fillText("World Peace Platform", 150, 370);
    ctx.fillText("world pride you", 200, 240)
    return canvas;
  }
  ...
  async function run() {
    ...
    const canvas = addWatermark(tempCanvas, wallet.getAccountId());
